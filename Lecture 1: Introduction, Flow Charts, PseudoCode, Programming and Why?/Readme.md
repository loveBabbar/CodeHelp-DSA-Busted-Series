...
<ul>
  ...
  <li>
    <b>Programming Languages </b> are special languages which can be converted into computer understandable format which is written in a fix format known as syntax.
  </li>
  <li>
